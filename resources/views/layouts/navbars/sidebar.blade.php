        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                <li class="me-0 me-xl-2">
                    {{-- <a class="btn btn-primary btn-sm d-flex gap-2 align-items-center" aria-current="page" href="#">
                        Profile
                    </a> --}}
                </li>
...
<aside class="sidebar sidebar-default sidebar-dark sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
            ...
            <!--Logo start-->
            <div >
                <img src="{{ asset('assets/images/ethica_logo.png') }}" class="logo" alt="logo-ethica" width="60">
            </div>
            <!--logo End-->
            <h6 class="logo-title" >Ethica Groups</h6>
        </a>
        <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
            <i class="icon">
